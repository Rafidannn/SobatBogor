...
function formatPrice(string|int|null $price): string
{
    if ($price === null || $price == 0)
        return '<span class="text-success fw-600">Gratis</span>';
...
<section class="hero-section">
    ...
    <!-- Decorative blobs -->
    <div
        style="position:absolute;top:-100px;right:-100px;width:400px;height:400px;border-radius:50%;background:rgba(234,88,12,0.15);filter:blur(80px);pointer-events:none;">
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-inline-flex align-items-center gap-2 mb-3"
                    ...
                    <span
                        style="width:8px;height:8px;border-radius:50%;background:linear-gradient(135deg,#1a6bbf,#3a9e3a);display:inline-block;"></span>
                ...
                <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">
                    Temukan ratusan destinasi wisata terbaik — dari pegunungan sejuk, kuliner lezat, hingga budaya
                    bersejarah di Kota Hujan.
                </p>
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    <form action="<?= BASE_URL ?>/destinations" method="GET" class="search-bar-wrapper">
                        ...
                        <input type="text" name="q" placeholder="Cari destinasi wisata di Bogor..."
                ...
                <div class="d-flex flex-wrap gap-3 mt-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    foreach ($heroStats as $hs): ?>
                        <div style="text-align:center;">
                            ...
                            <div style="font-size:0.78rem;color:rgba(255,255,255,0.6);margin-top:2px;"><?= $hs['label'] ?>
                            </div>
                        </div>
                ...
                <div class="d-flex flex-wrap gap-2 mt-4" data-aos="fade-up" data-aos-delay="400">
                    <a href="<?= BASE_URL ?>/peta"
                        class="btn d-inline-flex align-items-center gap-2 rounded-pill px-4 py-2"
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-2 category-pills" data-aos="fade-up"
            data-aos-delay="100">
            <a href="<?= BASE_URL ?>/destinations" class="pill <?= !isset($_GET['category']) ? 'active' : '' ?>">
                <i class="fas fa-th-large"></i> Semua
            </a>
            <?php foreach ($categories as $cat): ?>
                <a href="<?= BASE_URL ?>/destinations?category=<?= htmlspecialchars($cat['slug']) ?>" class="pill">
    ...
    <section class="py-5" style="background:var(--gray-50);">
        <div class="container">
            <div class="d-flex justify-content-between align-items-end mb-4" data-aos="fade-up">
                ...
                <a href="<?= BASE_URL ?>/destinations?featured=1"
                    class="btn-secondary-custom btn d-none d-md-inline-flex align-items-center gap-2">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="<?= $idx * 80 ?>">
                        <div class="destination-card">
                            <div class="card-img-wrapper">
                                ...
                                <?php else: ?>
                                    <div
                                        style="width:100%;height:100%;background:linear-gradient(135deg,#fed7aa,#fb923c);display:flex;align-items:center;justify-content:center;">
                                ...
                                <span class="badge position-absolute"
                                    style="top:44px;left:12px;<?= $statusInfo['style'] ?>;font-size:0.7rem;border-radius:50px;padding:0.25rem 0.65rem;backdrop-filter:blur(4px);z-index:2;">
                                    <?= $statusInfo['label'] ?>
                                </span>
                                ...
                                <button class="wishlist-btn <?= $isWishlisted ? 'active' : '' ?>"
                                    id="wish-btn-<?= $dest['id'] ?>" onclick="toggleWishlist(<?= $dest['id'] ?>, this)"
                                ...
                                <div class="card-footer-info">
                                    ...
                                    <div>
                                        <div class="ticket-price">
                                            <?= $pricing['formatted_today'] ?> <span
                                                style="font-size:0.72rem;color:var(--gray-500);font-weight:normal;"><?= $isCulinary ? '/ porsi' : '/ orang' ?></span>
                                        </div>
                                        <div style="font-size:0.72rem;color:var(--gray-500);">
                                            <span title="Harga Hari Kerja (Senin-Jumat)">WD:
                                                <?= $pricing['formatted_weekday'] ?></span> |
                                            <span title="Harga Akhir Pekan (Sabtu-Minggu)">WE:
                                                <?= $pricing['formatted_weekend'] ?></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="<?= ($idx % 4) * 70 ?>">
                        <div class="destination-card">
                            <div class="card-img-wrapper">
                                ...
                                <?php else: ?>
                                    <div
                                        style="width:100%;height:100%;background:linear-gradient(135deg,#dcfce7,#16a34a);display:flex;align-items:center;justify-content:center;">
                                ...
                                <?php $isWishlisted = in_array($dest['id'], $wishlistIds); ?>
                                <button class="wishlist-btn <?= $isWishlisted ? 'active' : '' ?>"
                                    id="wish-btn-r-<?= $dest['id'] ?>" onclick="toggleWishlist(<?= $dest['id'] ?>, this)"
                                    title="Wishlist">
                                    <i class="<?= $isWishlisted ? 'fas' : 'far' ?> fa-heart"></i>
                                </button>
                            </div>
                                ...
                                <div class="card-footer-info">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:0.68rem;color:var(--gray-500);">
                                            WD: <?= $pricingRecent['formatted_weekday'] ?> | WE:
                                            <?= $pricingRecent['formatted_weekend'] ?>
                                        </div>
                                    </div>
                                    <div class="rating-stars">
                                        <i class="fas fa-star" style="color:#f59e0b;font-size:0.72rem;"></i>
                                        <span
                                            style="color:var(--gray-500);font-size:0.78rem;"><?= $dest['avg_rating'] ?: '–' ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-5" style="background:linear-gradient(135deg,#0f172a 0%,#1e293b 100%);">
        <div class="container text-center py-3" data-aos="fade-up">
            ...
            <div class="d-flex justify-content-center gap-3 flex-wrap">
                ...
                <a href="<?= BASE_URL ?>/destinations" class="btn"
                    style="border:2px solid rgba(255,255,255,0.3);color:#fff;border-radius:50px;padding:0.65rem 1.75rem;font-weight:600;transition:var(--transition);"
...
<script>
    function toggleWishlist(destinationId, btn) {
        ...
        fetch(url, {
            ...
            .catch(() => {
                Swal.fire({
                    toast: true, position: 'top-end', icon: 'error', title: 'Gagal! Coba lagi.',
