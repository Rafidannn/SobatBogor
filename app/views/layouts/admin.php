        ...
        <div id="content">
            ...
            <div class="admin-topnav">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a href="<?= BASE_URL ?>/" class="btn btn-sm btn-outline-secondary rounded-pill" style="font-size:0.85rem;">
                        <i class="fa fa-external-link-alt me-1"></i>Lihat Website
                    </a>
                    <div class="dropdown">
                        <button class="btn btn-sm d-flex align-items-center gap-2 rounded-pill px-3" style="border:1.5px solid #e2e8f0;background:#fff;" data-bs-toggle="dropdown">
                            <span style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#1a6bbf,#3a9e3a);color:#fff;display:inline-flex;align-items:center;justify-content:center;font-size:0.75rem;font-weight:700;">
                                <?= strtoupper(substr($_SESSION['user_name'] ?? 'A', 0, 1)) ?>
                            </span>
                            <span style="font-weight:600;font-size:0.9rem;color:#0f172a;"><?= htmlspecialchars($_SESSION['user_name'] ?? 'Admin') ?></span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2" style="border-radius:12px;min-width:180px;">
                            <li><a class="dropdown-item" href="<?= BASE_URL ?>/"><i class="fa fa-home me-2 text-primary"></i>Beranda Web</a></li>
                            <li><hr class="dropdown-divider my-1"></li>
                            <li><a class="dropdown-item text-danger" href="<?= BASE_URL ?>/logout"><i class="fa fa-sign-out-alt me-2"></i>Keluar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <?php if (isset($_SESSION['error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <i class="fa fa-exclamation-circle me-2"></i> <?= $_SESSION['error']; unset($_SESSION['error']); ?>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            <?php endif; ?>
