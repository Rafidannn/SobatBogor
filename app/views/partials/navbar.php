...
<nav class="navbar navbar-expand-lg navbar-custom sticky-top" id="mainNavbar">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?= BASE_URL ?>/">
            ...
            <span
                style="font-family:'Outfit',sans-serif;font-weight:800;font-size:1.25rem;line-height:1;letter-spacing:-0.5px;">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav mx-auto gap-1">
                <li class="nav-item">
                    <a class="nav-link <?= $currentPath === '/' ? 'active' : '' ?>" href="<?= BASE_URL ?>/">
                ...
                <?php if ($isLoggedIn): ?>
                    ...
                    <div class="dropdown">
                        <button class="btn btn-sm d-flex align-items-center gap-2 rounded-pill px-3"
                            style="border:1.5px solid var(--gray-200);background:var(--white);" data-bs-toggle="dropdown">
                            <span
                                style="width:28px;height:28px;border-radius:50%;background:var(--primary);color:#fff;display:inline-flex;align-items:center;justify-content:center;font-size:0.75rem;font-weight:700;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2"
                            ...
                            <li><span class="dropdown-item-text text-muted"
                                    style="font-size:0.8rem;"><?= htmlspecialchars($userName) ?></span></li>
                            <li>
