...
function mapFormatPrice($price): string {
    if (!$price || (float)$price == 0) return 'Gratis';
...
.map-sidebar::-webkit-scrollbar-track { background: #f1f5f9; }
...
.popup-btn.hotel { background: linear-gradient(135deg, #1a6bbf, #3b82f6); }
...
@media (max-width: 768px) {
    .map-page-wrapper { height: auto; }
    .map-body { flex-direction: column; }
    .map-sidebar { width: 100%; height: 250px; border-right: none; border-bottom: 1px solid #e2e8f0; }
    #mainMap { height: 55vh; }
